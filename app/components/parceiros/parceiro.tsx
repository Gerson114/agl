            ...
            <div className="flex flex-wrap justify-center gap-5">
                {parceiros.map((p) => (
                    ...
                    >
                        ...
                        <div className="flex items-center justify-center w-14 h-14 rounded-[5px] bg-[#1E5BFB]/10 group-hover:bg-[#1E5BFB]/20 transition-colors duration-300">
                            <span className="text-[#1E5BFB] font-bold text-lg">
                                {p.sigla}
                            </span>
                        </div>
                        <p className="text-sm font-semibold text-gray-700 group-hover:text-[#1E5BFB] transition-colors duration-300">
                            {p.nome}
                        </p>
                    </div>
                ))}
